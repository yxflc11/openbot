...
| Linux Worker Host 服务与 Secret Service | [Secret Service API 0.2](https://specifications.freedesktop.org/secret-service/latest-single/)、[libsecret `0.21.7` / `0936f740`](https://github.com/GNOME/libsecret/tree/0936f740c02b60f02657729cd99f581db4517a41)、[systemd `v255` / `db11bab3`](https://github.com/systemd/systemd/tree/db11bab38ccf1ed257f310d29070843d4c58ea01)、[`@napi-rs/keyring` `2.0.0` / `f3449416`](https://github.com/Brooooooklyn/keyring-node/tree/f3449416a1b4bf11b0570f0a49395aacc84c8608) 与已归档 [`node-keytar` `7.9.0` / `5adb540f`](https://github.com/atom/node-keytar/tree/5adb540f8557801c52254e969a6c7ed9ef4d16f0) | 规范；LGPL-2.1-or-later；LGPL-2.1-or-later；MIT；MIT | 只在专用登录用户中采用 Secret Service，在无人值守专用账户中采用 systemd 加固。维护中的 Node 候选会静默退回另一种 Linux keyring，而 keytar 已归档，因此使用有界外部 `secret-tool` 适配器。后端、会话或工具失败都不会退回文件。未复制上游源码，见[调研证据](research/linux-worker-host-service-and-secret-service.md)。 |
