...
| Linux Worker Host 可验证压缩包 | 官方 [Node.js `v22.22.2` / `2645dc73`](https://github.com/nodejs/node/tree/2645dc73720b1b4f27c49f395d3c66025ce126cc)发布压缩包、[`@vercel/ncc` `0.45.0` / `cb1f1f05`](https://github.com/vercel/ncc/tree/cb1f1f058bfa7de4cb63f2411e14a724e714e260)、[npm CLI `10.9.8` / `dd3c80e9`](https://github.com/npm/cli/tree/dd3c80e9965d240957684e9951603cf22eaae74c) 与 [`actions/attest` `v4.2.2` / `1e69f48a`](https://github.com/actions/attest/tree/1e69f48acb82d1966a394da916b4c1698aa569d6) | Node.js 许可证；MIT；Artistic-2.0；MIT | 把应用打成一个可审计 JS 入口，与哈希已验证的官方运行时组合，并输出仅含生产依赖的 SPDX SBOM、规范文件清单和校验和。本地产物明确标为未签名；授权 tag workflow 无法生成来源证明时必须失败。SEA 仍在实验演进，`pkg` 已归档。未复制上游源码，见[调研证据](research/linux-worker-host-archive.md)。 |
